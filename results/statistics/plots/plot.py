...
#   plot-vcfstats -p results/statistics/plots results/statistics/variant_stats.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. SRR58 .. results/variants/SRR5887625.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='SRR58')
    has_data = 1
